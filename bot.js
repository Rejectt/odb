...
client.channels.find('id', '525621813762588682').setName("W");
client.channels.find('id', '525621813762588682').setName("We");
client.channels.find('id', '525621813762588682').setName("Wel");
client.channels.find('id', '525621813762588682').setName("Welc");
client.channels.find('id', '525621813762588682').setName("Welco");
client.channels.find('id', '525621813762588682').setName("Welcom");
client.channels.find('id', '525621813762588682').setName("Welcome");
client.channels.find('id', '525621813762588682').setName("Welcome T");
client.channels.find('id', '525621813762588682').setName("Welcome To");
client.channels.find('id', '525621813762588682').setName("Welcome To H");
client.channels.find('id', '525621813762588682').setName("Welcome To el");
client.channels.find('id', '525621813762588682').setName("Welcome To Help");
client.channels.find('id', '525621813762588682').setName("Welcome To Help Center");
  }, 4000);
});
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let jscodes = message.guild.channels.find(`name`, "codes");
